                                                      ...
                                                      <ul>
                                                          ...
                                                          <li>
                                                              ...
                                                              <ul>
                                                                  ...
                                                                  <li>
                                                                      <Link to="/cart" onClick={() => window.reload()}>Shop Cart</Link>
                                                                  </li>
                                                                  <li>
                                          ...
                                          <div className="woocommerce">
                                              <nav className="woocommerce-MyAccount-navigation">
                                                  <ul>
                                                      ...
                                                      <li>
                                                          <Link to="/login_logout" onClick={() => window.reload()}>Login</Link>
                                                      </li>
                                                  </ul>
                                              </nav>
                                              ...
                                              <div className="woocommerce-MyAccount-content">
                                                  ...
                                                  <form className="woocommerce-EditAccountForm edit-account" action="https://html.modernwebtemplates.com/" method="post">


                                                      <p className="woocommerce-form-row woocommerce-form-row--first form-row form-row-first">
                                                          <label htmlfor="account_first_name">First name <span className="required">*</span>
                                                          </label>
                                                          <input type="text" className="woocommerce-Input woocommerce-Input--text input-text" name="account_first_name" id="account_first_name" value=""/>
                                                      </p>
                                                      <p className="woocommerce-form-row woocommerce-form-row--last form-row form-row-last">
                                                          <label htmlfor="account_last_name">Last name <span className="required">*</span>
                                                          </label>
                                                          <input type="text" className="woocommerce-Input woocommerce-Input--text input-text" name="account_last_name" id="account_last_name" value=""/>
                                                      </p>
                                                      <div className="clear">
                                                      ...
                                                      <p className="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                                                          <label htmlfor="account_email">Email address <span className="required">*</span>
                                                          </label>
                                                          <input type="email" className="woocommerce-Input woocommerce-Input--email input-text" name="account_email" id="account_email" value="admin@test.com"/>
                                                      </p>
