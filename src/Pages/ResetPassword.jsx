                    ...
                    <div className="nav-wrap">
                      ...
                      <nav className="top-nav">
                        <ul className="nav sf-menu">
                          ...
                          {/* <!-- contacts --> */}
                          <li>
                            <Link to="/contacts" onClick={() => window.reload()}>Contact</Link>
                          </li>
                          {/* <!-- eof contacts --> */}
                        </ul>
            ...
            <div className="container">
              <div className="row">
                <main className="col-lg-12">
                  <form action="#" className="woocommerce-ResetPassword lost_reset_password">
                    ...
                    <p className="woocommerce-form-row woocommerce-form-row--first form-row form-row-first">
                      ...
                      <input className="woocommerce-Input woocommerce-Input--text input-text" type="text" name="user_login" id="user_login"/>
                    </p>
